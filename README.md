...
FlightOrFlight is designed around normalized fare observations. The analytics layer does not require any one specific provider.

Recommended data-source approaches:

- user-provided fare data
- CSV imports
- official APIs
- affiliate or partner APIs
- licensed fare data
- locally collected observations where permitted

Browser automation adapters should be treated as experimental and for personal research only. Users are responsible for complying with the terms of service of any travel provider, airline, OTA, or website they access.

---

## Important disclaimer

This project is for personal, educational, and experimental travel analytics purposes.

FlightOrFlight is not affiliated with Google, Google Flights, Expedia, any airline, or any travel provider.

Prices are observations and may change at any time. Always verify the final price, itinerary, baggage rules, fees, and terms directly with the provider before booking.

Do not use this project to bypass CAPTCHAs, login walls, bot protections, rate limits, or technical access controls.
...
- store provider/deep link metadata
- support hotel and package observations
- add user-defined alert thresholds
- add email or push alerts
- migrate from SQLite to Postgres for hosted use
- add job queue support
- add route comparison mode
- add multi-destination scanning
- add import/export support
- add pluggable provider adapters
- add confidence scores for scraped observations
- add stale-link detection
...
> FlightOrFlight is a flexible-travel analytics dashboard that scans possible trip windows, ranks the cheapest dates, and explains whether an observed fare is actually a good deal.

The product is not just a flight search page. It is a travel-window intelligence tool.
...
For open source, common options include:

- MIT License
- Apache 2.0
- GPLv3

If this project is primarily a portfolio or personal tool, you can also leave it unlicensed until you decide how you want others to use it.
